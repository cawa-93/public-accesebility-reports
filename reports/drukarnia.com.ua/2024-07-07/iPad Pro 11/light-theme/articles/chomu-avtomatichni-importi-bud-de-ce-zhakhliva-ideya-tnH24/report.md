...
- `#headlessui-popover-button-393166 > .hover\:bg-white.dark\:hover\:bg-gray-900.text-gray-900`
...
- `.mt-4 > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.border-brand-2 > .profile-info.flex-col.justify-center > div > .text-gray-500.dark\:text-gray-400`
...
- `.mt-4 > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.border-brand-2 > .profile-info.flex-col.justify-center > div > .profile-stats.my-6.max-w-xs > .mr-6.flex-col[title="5263"] > .font-semibold.text-gray-500.dark\:text-gray-400`

	![screenshot](screenshots/12-0.jpg)
- `.mt-4 > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.border-brand-2 > .profile-info.flex-col.justify-center > div > .profile-stats.my-6.max-w-xs > .border-x.border-gray-300.px-6 > .font-semibold.text-gray-500.dark\:text-gray-400`

	![screenshot](screenshots/13-0.jpg)
- `.mt-4 > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.border-brand-2 > .profile-info.flex-col.justify-center > div > .profile-stats.my-6.max-w-xs > .ml-6.text-inherit.flex-col > .font-semibold.text-gray-500.dark\:text-gray-400`
...
- `section[aria-labelledby="semantic-section-842508"] > .w-full.hover\:bg-white[href$="dostupnist"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/16-0.jpg)
- `section[aria-labelledby="semantic-section-842509"] > .w-full.hover\:bg-white[href$="ui-ux"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/17-0.jpg)
- `section[aria-labelledby="semantic-section-842510"] > .w-full.hover\:bg-white[href$="css"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/18-0.jpg)
- `section[aria-labelledby="semantic-section-842512"] > .w-full.hover\:bg-white[href$="javascript"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/19-0.jpg)
- `section[aria-labelledby="semantic-section-842513"] > .w-full.hover\:bg-white[href$="expo"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/20-0.jpg)
- `section[aria-labelledby="semantic-section-842514"] > .w-full.hover\:bg-white[href="/themes/js"] > .rounded-md.px-1\.5.py-0\.5`
