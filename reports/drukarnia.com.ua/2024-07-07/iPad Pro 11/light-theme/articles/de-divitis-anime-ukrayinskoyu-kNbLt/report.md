...
- `#headlessui-popover-button-333660`
...
- `#headlessui-popover-button-333660 > button`
...
- `.mt-4 > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.text-center > .profile-info.justify-center.flex-col > div > .profile-stats.my-6.max-w-xs > .mr-6.flex-col[title="5250"] > .text-gray-500.dark\:text-gray-400.text-sm`

	![screenshot](screenshots/6-0.jpg)
- `.mt-4 > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.text-center > .profile-info.justify-center.flex-col > div > .profile-stats.my-6.max-w-xs > .border-x.border-gray-300.px-6 > .text-gray-500.dark\:text-gray-400.text-sm`

	![screenshot](screenshots/7-0.jpg)
- `.mt-4 > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.text-center > .profile-info.justify-center.flex-col > div > .profile-stats.my-6.max-w-xs > .ml-6.text-inherit.flex-col > .text-gray-500.dark\:text-gray-400.text-sm`
...
- `section[aria-labelledby="semantic-section-710865"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="dostupnist"] > .px-1\.5.py-0\.5.bg-primary-50`

	![screenshot](screenshots/10-0.jpg)
- `section[aria-labelledby="semantic-section-710866"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="ui-ux"] > .px-1\.5.py-0\.5.bg-primary-50`

	![screenshot](screenshots/11-0.jpg)
- `section[aria-labelledby="semantic-section-710867"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="css"] > .px-1\.5.py-0\.5.bg-primary-50`

	![screenshot](screenshots/12-0.jpg)
- `section[aria-labelledby="semantic-section-710869"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="ukrayinska-literatura"] > .px-1\.5.py-0\.5.bg-primary-50`

	![screenshot](screenshots/13-0.jpg)
- `section[aria-labelledby="semantic-section-710870"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="metal"] > .px-1\.5.py-0\.5.bg-primary-50`

	![screenshot](screenshots/14-0.jpg)
- `section[aria-labelledby="semantic-section-710871"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="ukrayina"] > .px-1\.5.py-0\.5.bg-primary-50`
...
- `iframe`
	...
	![screenshot](screenshots/16-0.jpg), ![screenshot](screenshots/16-1.jpg)
...
- `section[aria-labelledby="semantic-section-710865"]`
...
- `#headlessui-popover-button-333658`

	![screenshot](screenshots/19-0.jpg)
- `#headlessui-popover-button-333660`

	![screenshot](screenshots/20-0.jpg)
- `#headlessui-popover-button-333662`
