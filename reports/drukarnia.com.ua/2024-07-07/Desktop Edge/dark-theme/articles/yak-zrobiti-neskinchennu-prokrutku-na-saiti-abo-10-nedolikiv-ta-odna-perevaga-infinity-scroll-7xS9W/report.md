...
- `#headlessui-popover-button-391237`

	![screenshot](screenshots/3-0.jpg)
- `#headlessui-menu-button-391239`
...
- `.text-base`
	...
	![screenshot](screenshots/6-0.jpg), ![screenshot](screenshots/6-1.jpg)
- `#headlessui-popover-button-391237 > button`

	![screenshot](screenshots/7-0.jpg)
- `#headlessui-menu-button-391239 > .hover\:bg-primary-50.dark\:hover\:bg-primary-800`
...
- `section[aria-labelledby="semantic-section-838322"]`
...
- `#headlessui-popover-button-391235`
...
- `#headlessui-popover-button-391240`
