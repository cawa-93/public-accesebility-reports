...
- `#headlessui-popover-button-397530`

	![screenshot](screenshots/4-0.jpg)
- `#headlessui-menu-button-397532`
...
- `#headlessui-popover-button-397530 > .hover\:bg-white.dark\:hover\:bg-gray-900.text-gray-900`

	![screenshot](screenshots/11-0.jpg)
- `#headlessui-menu-button-397532 > .hover\:bg-primary-50.dark\:hover\:bg-primary-800.hover\:text-primary`
...
- `.gap-4.flex-col.flex > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.text-center > .profile-info.flex-col.justify-center > div > .profile-stats.my-6.max-w-xs > .mr-6.flex-col[title="5263"] > .font-semibold.text-gray-500.dark\:text-gray-400`
...
- `section[aria-labelledby="semantic-section-851686"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="dostupnist"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/19-0.jpg)
- `section[aria-labelledby="semantic-section-851687"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="css"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/20-0.jpg)
- `section[aria-labelledby="semantic-section-851688"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="javascript"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/21-0.jpg)
- `section[aria-labelledby="semantic-section-851694"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="veb-rozrobka"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/22-0.jpg)
- `section[aria-labelledby="semantic-section-851695"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="programuvannya"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/23-0.jpg)
- `section[aria-labelledby="semantic-section-851696"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="knigi"] > .rounded-md.px-1\.5.py-0\.5`
...
- `section[aria-labelledby="semantic-section-851686"]`
...
- `#headlessui-popover-button-397528`
...
- `#headlessui-popover-button-397533`
