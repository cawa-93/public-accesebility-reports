...
- `#headlessui-popover-button-406736`

	![screenshot](screenshots/3-0.jpg)
- `#headlessui-menu-button-406738`
...
- `#headlessui-popover-button-406736 > .hover\:bg-white.dark\:hover\:bg-gray-900.text-gray-900`

	![screenshot](screenshots/10-0.jpg)
- `#headlessui-menu-button-406738 > .hover\:bg-primary-50.dark\:hover\:bg-primary-800.hover\:text-primary`
...
- `.gap-4.flex-col.flex > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.text-center > .profile-info.flex-col.justify-center > div > .profile-stats.my-6.max-w-xs > .mr-6.flex-col[title="5269"] > .text-gray-500.dark\:text-gray-400.text-sm`

	![screenshot](screenshots/14-0.jpg)
- `.gap-4.flex-col.flex > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.text-center > .profile-info.flex-col.justify-center > div > .profile-stats.my-6.max-w-xs > .border-x.border-gray-300.px-6 > .text-gray-500.dark\:text-gray-400.text-sm`

	![screenshot](screenshots/15-0.jpg)
- `.gap-4.flex-col.flex > .profile.rounded-2xl.bg-brand-light > .profile-info-container.border-b.text-center > .profile-info.flex-col.justify-center > div > .profile-stats.my-6.max-w-xs > .ml-6.text-inherit.flex-col > .text-gray-500.dark\:text-gray-400.text-sm`
...
- `section[aria-labelledby="semantic-section-871689"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="dostupnist"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/18-0.jpg)
- `section[aria-labelledby="semantic-section-871690"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="ui-ux"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/19-0.jpg)
- `section[aria-labelledby="semantic-section-871691"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="css"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/20-0.jpg)
- `section[aria-labelledby="semantic-section-871697"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="shtuchnii-intelekt"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/21-0.jpg)
- `section[aria-labelledby="semantic-section-871698"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="tekhnologiyi"] > .rounded-md.px-1\.5.py-0\.5`

	![screenshot](screenshots/22-0.jpg)
- `section[aria-labelledby="semantic-section-871699"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="taro"] > .rounded-md.px-1\.5.py-0\.5`
...
- `section[aria-labelledby="semantic-section-871689"]`
...
- `#headlessui-popover-button-406734`
...
- `#headlessui-popover-button-406739`
