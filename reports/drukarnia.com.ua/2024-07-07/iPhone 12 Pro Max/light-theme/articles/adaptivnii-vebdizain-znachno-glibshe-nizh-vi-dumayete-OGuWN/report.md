...
- `section[aria-labelledby="semantic-section-846323"] > .hover\:bg-white.dark\:hover\:bg-gray-900[href$="dostupnist"] > .rounded-md.px-1\.5.py-0\.5`
...
- `pre:nth-child(56) > code`
	...
	![screenshot](screenshots/80-0.jpg)
